...
# Linker 
LSCRIPT = STM32F030R8Tx_FLASH.ld

# C Flags
GCFLAGS  = -Wall -std=c99 -fno-common -mthumb -mcpu=$(CPU) -DSTM32F030R8T6 --specs=nosys.specs -g -Wa,-ahlms=$(addprefix $(OBJDIR)/,$(notdir $(<:.c=.lst)))
GCFLAGS += $(INCLUDE)
